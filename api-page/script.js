...
document.addEventListener("DOMContentLoaded", async () => {
  ...
  const populatePageContent = () => {
    ...
    const creator = settings.apiSettings?.creator || "Finix Api'S"

    setPageContent(DOM.pageTitle, settings.name, "Finix Api'S")
    setPageContent(DOM.wm, `© ${currentYear} Finix Api'S Corp. All rights reversed.`)
    setPageContent(DOM.appName, settings.name, "Finix Api'S")
